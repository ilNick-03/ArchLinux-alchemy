...
----  Just in case you want to switch from AETHER's Waybar to your customized Noctalia.
----  Otherwise, ignore this code or delete it.
------   See also:  https://docs.noctalia.dev/noctalia/compositor-settings/hyprland/
